...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnStartpdf = (Button) findViewById(R.id.pdf_download);


        btnStartpdf.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                Intent sd = new Intent(MainActivity.this, StartDownload.class);
                startActivity(sd);
